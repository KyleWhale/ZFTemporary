...
+ (UIImage *)imageNamed:(NSString *)name {
    ...
    return [UIImage imageNamed:[NSString stringWithFormat:@"ZFTemporary.bundle/%@", name] inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
}
